...
function fillUserAccount(dataUser) {
  ...
  if (dataUser[0].image) {
    userPhoto.style.backgroundImage = "url(\"./".concat(dataUser[0].image, "\")");
  } else {
...
function _getUserData() {
  _getUserData = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var token, dataUser;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0,_services_request__WEBPACK_IMPORTED_MODULE_3__.default)('/user/api/userData', 'POST', {
              token: token
            });
...
function goOutUser() {
  localStorage.setItem("".concat(_services_constants__WEBPACK_IMPORTED_MODULE_4__.LSTORAGEID, "token"), 0);
}
...
/******/ 		
/******/ 		var deferredModules = [
/******/ 			["./page-user/index.js","vendors-node_modules_bootstrap_dist_js_bootstrap_esm_js","vendors-node_modules_regenerator-runtime_runtime_js"]
/******/ 		];
...
/******/ })()
;
//# sourceMappingURL=pageUser.fcfa332d95f7d9a5465c.js.map