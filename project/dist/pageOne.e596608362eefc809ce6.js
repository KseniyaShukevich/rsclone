    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_services_request__WEBPACK_IMPORTED_MODULE_4__.default)('/api/contacts');

          case 2:
            data = _context.sent;
            _context.next = 5;
            return (0,_services_request__WEBPACK_IMPORTED_MODULE_4__.default)('/api/contacts', 'POST', contact);

          case 5:
            dataPost = _context.sent;
            _context.next = 8;
            return (0,_services_request__WEBPACK_IMPORTED_MODULE_4__.default)("/api/contacts/".concat(id), 'DELETE');

          case 8:
            result = _context.sent;
            _context.next = 11;
            return (0,_services_request__WEBPACK_IMPORTED_MODULE_4__.default)("/api/contacts/".concat(id), 'PUT', _objectSpread(_objectSpread({}, contact), {}, {
              marked: true
            }));
...
/******/ })()
;
//# sourceMappingURL=pageOne.e596608362eefc809ce6.js.map